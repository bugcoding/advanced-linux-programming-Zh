...
* [入门指南](#1)
  ...
  * [使用GCC编译](#1-2)
    * [编译单个文件](#1-2-1)
    * [链接目标文件](#1-2-2)
  * [使用**GNU Make**自动处理](#1-3)
  * [使用GNU 调试器调试程序（GDB）](#1-4)
    * [编译生成调试信息](#1-4-1)
    * [运行GDB](#1-4-2)
  * [查看更多信息](#1-5)
    * [帮助手册](#1-5-1)
...
Linux内核的源代码通常会放在/usr/src/linux目录下，如果这本书让你渴望更详细的了解系统如何运行处理，共享内存，和系统设备如何工作，你可以直接去看源代码学习，这本书中大多数系统函数在GNU C库都有实现。可以通过查看发行版文档说明，找到C库源代码位置。
