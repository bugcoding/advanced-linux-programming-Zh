...
这章将会教你创建一个Linux下的c/c++程序的基本步骤，另外，这章还会教你怎样去创建，修改和编译c/c++源代码，并且最后调试程序结果。如果你已对于Linux的编程非常熟练，那么你可以跳过这里直接看章节2（写标准的GNU/Linux软件），应该多多留意一下2.3节，“编写和使用库”，对于静态和动态链接你可能知道得并不是很清楚。
